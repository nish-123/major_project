...
def predict():
    if request.method == 'POST':
        ...
        if(Gender_Male == 'Male'):
            ...
            Gender_Male = 0
            Gender_Female = 1
        prediction = model.predict([[CreditScore,Age,Tenure,Balance,NumOfProducts,HasCrCard,IsActiveMember,EstimatedSalary,Geography_Mumbai,Geography_Chennai,Gender_Male]])
        if prediction==1:
